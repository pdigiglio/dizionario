...
\newglossaryentry{rorido}{% 6
    name        = {Rorido},% 2017-04-11
    description = {\wom{aprile 2017}{(dal latino \emph{ros}, \emph{roris} <<ruggiada>>)~--- Ruggiadoso, bagnato dalla ruggiada. \est~\ex{``Rorida di morte il bianco aspetto''} (Manzoni), aspersa dal sudore della morte}}%
}

\newglossaryentry{redimire}{% 8
    name        = {Redimire},% 2017-07-08
    description = {\wom{luglio 2017}{\upag{\lett~Incoronare, cingere: \ex{capo redimito di alloro}. \est~Ornato: \ex{romanzo redimito di riferimenti}}}}%
}
