...
\newglossaryentry{fregola}{% 7
    name        = {Fregola},% 2016-08-14
    description = {(da \emph{fregare}, riferito ai pesci che si fregano ai sassi al tempo di deporre le uova)~--- \switch{1}~Eccitazione sessuale degli animali che di norma si conclude con la fecondazione. \switch{2}~\fig~Voglia smaniosa, frenesia: \ex{gli è venuta la fregola di scrivere versi}}%
}
