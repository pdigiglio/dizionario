...
\newglossaryentry{politropo}{% 9
    name        = {Politropo},% 2016-07-23
    description = {(epiteto omerico di Ulisse)~--- Che ha ingegno versatile, multiforme; scaltro astuto}%
}

\newglossaryentry{postribolo}{% 10
    name        = {Postribolo},% 2016-07-29
    description = {Luogo dove si esercita la prostituzione, bordello}%
}

\newglossaryentry{pugnace}{% 7
    name        = {Pugnace},% 2016-09-16
    description = {\switch{1}~Pronto e deciso a combattere, bellicoso. \fig~Combattivo, ardito, soprattutto in lotte ideali. \switch{2}~\est~Che spinge al combattimento: \ex{``sognante su l’albe gelide le d\"iane e il rullo pugnace''} (Carducci)}%
}

\newglossaryentry{pusigno}{% 7
    name        = {Pusigno},% 2016-09-24
    description = {Piccolo pasto, per lo più di vivande ghiotte, che si consuma a tarda ora dopo cena}%
}

\newglossaryentry{perentorio}{% 10
    name        = {Perentorio},% 2016-09-24
    description = {(dal latino \emph{perimēre}, cioè \emph{distruggre} o \emph{annientare})~--- \switch{1}~Che non ammette proroga. \giur~Il termine temporale la cui decorrenza dà luogo a decadenza assoluta di un diritto o di una facoltà; ad esempio il termine stabilito dalla legge per l'impugnazione delle sentenze. \switch{2}~\est~Che non ammette replica, discussione od obiezione}%
}

\newglossaryentry{pampino}{% 7
    name        = {P\`ampino},% 2016-10-25
    description = {La foglia della vite: \ex{Bacco è comunemente raffigurato con la fronte coronata di pampini}. Locuzioni: \ex{dare pampini per uva}, illudere con vane promesse; \ex{andare ai pampini}, di vite che si veste di molte foglie senza dare frutto o di persona vana e inconcludente}%
}

\newglossaryentry{patrocinare}{% 11
    name        = {Patrocinare},% 2017-03-13
    description = {\switch{1}~Difendere in giudizio: \ex{patrocinare una delle parti in causa}. Con uso assoluto, esercitare la professione di avvocato: \ex{gli avvocati sono ammessi a patrocinare}. \switch{2}~\est~Sostenere, appoggiare, proteggere: \ex{patrocinare le rivendicazioni}, \ex{patrocinare un'iniziativa culturale}}%
}

\newglossaryentry{pacioso}{% 7
    name        = {Pacioso},% 2017-03-09
    description = {Di persona pacifica, amante del quieto vivere, calma e tranquilla anche nell'aspetto e nei modi di fare}%
}

\newglossaryentry{piorno}{% 6
    name        = {Pi\'orno},% 2018-08-21
    description = {\wom{agosto 2018}{Piovoso}}%
}
