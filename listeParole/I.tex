...
\newglossaryentry{impronto}{% 8
    name        = {Impronto},% 2017-09-23
    description = {(da <<in promptu>>, \emph{a disposizione})~--- Di persona che manca di delicatezza e discrezione; inopportuno, sfacciato. \emph{All'impronto} (o \emph{all'impronta}), di getto: \ex{rappresentare una farsa all'impronto/a}}%
}

\newglossaryentry{irenico}{% 7
    name        = {Irenico},% 2018-06-25
    description = {\wom{luglio 2018}{Di pace, portatore di pace}}%
}
