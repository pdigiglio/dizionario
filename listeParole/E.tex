...
\newglossaryentry{ecatombe}{% 8
    name        = {Ecatombe},% 2017-03-08
    description = {(etimologicamente, sacrificio di cento buoi; come quello che, unico in età storica, fu offerto a Conone dopo la vittoria a Cnido nel 394~a.C.)~---\switch{1}~Sacrificio di più vittime presso gli antichi Greci. \switch{2}~\fig~Strage, sterminio}%
}
