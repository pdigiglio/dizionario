...
\newglossaryentry{ed\`otto}{% 8
    name        = {Ed\`otto},% 2016-05-05
    description = {Informato di una cosa: \ex{sono già ed\'otto dei fatti}}%
}

\newglossaryentry{ed\'otto}{% 7
    name        = {Ed\'otto},% 2016-05-05
    description = {Tratto o condotto fuori}%
}
