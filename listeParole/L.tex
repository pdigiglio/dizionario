...
\newglossaryentry{labronico}{% 9
    name        = {Labronico},% 2017-02-10
    description = {(dal nome \emph{Labro}/\emph{-onis} che, in una lettera di Cicerone, indica un porto sulla costa tirrenica identificato con quello di Livorno ma forse da collocare nell'odierna Castiglioncello)~--- \lett~Livornese, di Livorno}%
}
