...
\newglossaryentry{sardonico}{% 9
    name        = {Sardonico},% 2016-07-22
    description = {\switch{1}~Di riso, beffardo, maligno, sprezzante, sarcastico. \switch{2}~\med~\ex{Riso sardonico}, smorfia convulsiva con stiramento degli angoli della bocca provocata da uno sparmo dei nervi facciali, specialmente nei malati di tetano}%
}

\newglossaryentry{serico}{% 6
    name        = {Serico},% 2016-07-19
	description = {\wom{luglio 2016}{\upag{(da \emph{Seres}, popolo dell'Asia centrale famoso in antichità per la fabricazione e lavorazione della seta)~---~Che è di seta o che riguarda la seta. \est~Che ha le caratteristiche di morbidezza, lucentezza e liscezza della seta}}}%
}

\newglossaryentry{scevro}{% 6
    name        = {Scevro},% 2016-07-24
	description = {\switch{1}~\ant~Separato, lontano: \ex{``Onde Beatrice, ch’era un poco scevra''} (Dante). \switch{2}~\lett~Privo; immune, esente: \ex{un'impresa non scevra di risch\^i}}%
}

\newglossaryentry{sedizione}{% 9
    name        = {Sedizione},% 2016-08-27
    description = {Moto insurrezionale contro l'ordine costituito, rivolta, sommossa}%
}

\newglossaryentry{satiriasi}{% 9
    name        = {Satiriasi},% 2016-11-26
    description = {Eccesso patologico del senso erotico nell'uomo (analogo maschile di \emph{ninfomania})}%
}

\newglossaryentry{sicumera}{% 8
    name        = {Sicumera},% 2017-04-07
    description = {Atteggiamento di superiorità altezzosa, sussiego, presunzione}%
}
