...
\newglossaryentry{coonestare}{% 10
    name        = {Coonestare},% 2017-07-08
    description = {\upag{Giustificare un'azione con argomenti mendaci per farla apparire giusta od onesta}}%
}

\newglossaryentry{capestro}{% 8
    name        = {Capestro},% 2018-08-21
    description = {\switch{1}~Fune grossa con la quale si legano alcuni animali (buoi, vacche, cavalli) per la testa; cavezza. \ex{Rompere il capestro}, liberarsi da ogni soggezione; \ex{porre il capestro a qualcuno}, sottometterlo alla propria volont\`a. \switch{2}~La corda usata per l'impiccagione e~\est~la forca stessa. \switch{3}~\agg~Che pone condizioni molto dure, che opprime. \switch{4}~\ant~Il cordiglio dei francescani}%
}
